...
const About = () => {
    return (
        <div>
            <Section paddingTop='pt-5' classes="row">
                <div className="col-md-6 d-none d-lg-block d-lg-none">
                ...
                <div className="col-md-6 about">
                    ...
                    <h2 className='about-header'>The first <br></br>of its kind in Africa</h2>
